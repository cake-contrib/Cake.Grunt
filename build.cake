...
var solutionPath            = MakeAbsolute(File(Argument("solutionPath", "Cake.Grunt.sln")));
var projectName             = Argument("projectName", "Cake.Grunt");
...
var testAssemblies          = new List<FilePath> { 
                                MakeAbsolute(File("./src/Cake.Grunt.Tests/bin/" + configuration + "/Cake.Grunt.Tests.dll"))
                              };
